...
public class ListaSimpleAve {
    
    Nodo cabeza = null;
    int tamaño = 0;
    
    public void insertarPrincipioNodo(String nombreAve, String habitatAve, String alimentacionAve, String reproduccionAve, String tipoAve, int numExtremidades, String tipoExtremidades) {

        Nodo nodoNuevo = new Nodo(new Ave (nombreAve, habitatAve, alimentacionAve, reproduccionAve, tipoAve, numExtremidades, tipoExtremidades));
    ...
    public void insertarFinaloNodo(String nombreAve, String habitatAve, String alimentacionAve, String reproduccionAve, String tipoAve, int numExtremidades, String tipoExtremidades) {
        Nodo nodoNuevo = new Nodo(new Ave (nombreAve, habitatAve, alimentacionAve, reproduccionAve, tipoAve, numExtremidades, tipoExtremidades));
        Nodo apuntador;
    ...
    public Ave obtenerAve(int index) {
        Nodo apuntador = null;
        if (cabeza != null) {
            int contador = 0;
            apuntador = cabeza;
