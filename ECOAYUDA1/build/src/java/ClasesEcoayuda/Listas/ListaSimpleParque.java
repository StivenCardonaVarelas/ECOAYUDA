 ...
 * @author stive
 */
public class ListaSimpleParque {
    Nodo cabeza = null;
    int tamaño = 0;
    
    public void insertarPrincipioNodo(String nombre,String ubicacion, String telefono, String horario) {

        Nodo nodoNuevo = new Nodo(new ParqueNatural (nombre, ubicacion, telefono, horario));
    ...
    public ParqueNatural obtenerParque(int index) {
        Nodo apuntador = null;
        if (cabeza != null) {
            int contador = 0;
            apuntador = cabeza;
